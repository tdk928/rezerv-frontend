...
- Обновени: `.cursor/rules/design-system.mdc` + REZERV.md §5.2 (новата палитра)
  и статус таблицата.
- **`docs/DESIGN.md`** — пълната дизайн спецификация (философия, токени, gradient
  utilities, компонентни рецепти, layout/responsive правила, състояния, do/don't).
  Одобрена от собственика; нови екрани се правят по нея без допълнителни обяснения.
  Design-system правилото сочи към нея.
