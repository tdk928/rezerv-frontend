...
| # | Бранч | Обобщение |
|---|-------|-----------|
| 5 | feature/multi-company-ui | Multi-company: navbar dropdown за активна фирма (`switch-company`), „Нова фирма“ винаги за логнати, `companies/mine`, `companyIds` в user. Onboarding без блок след първа фирма. 401→logout. |
